...
- Расширенные функции `insert`, `trim`, `s21_sprintf`, `s21_sscanf`, `to_upper`, `to_lower`
- Платформозовисимые списки ошибок для `strerror`
...
make test
```
После тестирования в консоле будет выведины результаты тестов.
#### Пример вывода
``` bash
